 ...
 */
package com.wolfyscript.scaffolding.eval.value_provider
...
interface ValueProvider<V> : Keyed {
    ...
    class ValueDeserializer : com.wolfyscript.scaffolding.config.jackson.ValueDeserializer<ValueProvider<*>>(ValueProvider::class.java) {
    ...
    class ValueSerializer : com.wolfyscript.scaffolding.config.jackson.ValueSerializer<ValueProvider<*>>(ValueProvider::class.java) {
