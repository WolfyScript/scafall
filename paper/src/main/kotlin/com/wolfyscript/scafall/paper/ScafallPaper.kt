...
class ScafallPaper(val classLoader: ClassLoader, val plugin: JavaPlugin) : ScafallCommon(), ScafallBootstrap.ScafallModule {
    ...
    override val adventure: PaperAdventureUtil = PaperAdventureUtil(this)
    ...
    /**
     * initiates everything that requires the Plugin to be enabled.
     */
