...
import com.wolfyscript.scafall.spigot.platform.world.items.CustomItemBlockData
import com.wolfyscript.scafall.spigot.platform.world.items.ItemUtils.isAirOrNull
import com.wolfyscript.scafall.spigot.platform.world.items.events.CustomItemPlaceEvent
...
class CustomItemDataListener(private val core: Scafall) : Listener {
    @EventHandler
