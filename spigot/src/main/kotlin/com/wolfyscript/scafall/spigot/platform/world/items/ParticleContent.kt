...
class ParticleContent {
    ...
    open class Settings {
        @JsonIgnore
        private var wolfyUtils: Scafall? = null
        private var animation: ParticleAnimation? = null

        protected constructor(wolfyUtils: Scafall?) {
        ...
        fun setAnimation(animation: Key) {
            this.animation = ScafallProvider.get().registries.particleAnimations[animation]
        }
    ...
    class PlayerSettings : Settings {
        ...
        constructor(wolfyUtils: Scafall?) : super(wolfyUtils)
