...
import com.wolfyscript.scaffolding.spigot.platform.particles.ParticleAnimation.ParticleEffectSettings
import com.wolfyscript.scaffolding.spigot.platform.particles.pos.*
...
//        PlayerUtils.setActiveParticleEffect(player, slot, Scheduler(player).start())
    ...
    inner class Scheduler(private val pos: ParticlePos, private val receiver: Player?) :
         ...
         */
        fun start(): UUID {
            this.task = ScaffoldingProvider.get().scheduler.syncTimerTask(
                ScaffoldingProvider.get().corePlugin,
                this, delay.toLong(), 1
            )
