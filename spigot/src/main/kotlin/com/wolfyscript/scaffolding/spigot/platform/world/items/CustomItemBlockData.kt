...
import com.wolfyscript.scaffolding.spigot.platform.particles.ParticleUtils.stopAnimation
...
import com.wolfyscript.scaffolding.spigot.platform.world.items.events.CustomItemBreakEvent
...
class CustomItemBlockData : CustomBlockData {
    ...
    @JsonCreator
    constructor(
        @JacksonInject core: Scaffolding,
