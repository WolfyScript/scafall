...
abstract class Action<T : Data> protected constructor(
    private val key: Key, @field:JsonIgnore val dataType: Class<T>
) :
    Keyed {
    abstract fun execute(core: Scaffolding, data: T)
