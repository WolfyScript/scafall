...
import com.wolfyscript.scaffolding.dependency.DependencySource
import com.wolfyscript.scaffolding.dependency.MissingImplementationException
...
open class StackReference : Copyable<StackReference> {
    ...
    constructor(core: Scaffolding, amount: Int, weight: Double, identifier: StackIdentifier, itemStack: ItemStack?) {
        this.core = core
        this.amount = amount
        this.weight = weight
    ...
    constructor(core: Scaffolding, amount: Int, weight: Double, parserKey: Key, item: ItemStack?) {
        this.amount = amount
        this.weight = weight
        this.core = core
